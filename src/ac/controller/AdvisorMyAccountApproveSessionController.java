          ...
          if(isCommit){
        	  if(isNewDatesCommit){
				...
				String content4 = "Hello, <br><br>"
						...
						+ "Advisor Name:"+name+""
								+ "<br>"
						+ "Reply:"+sessionPlan+"<br>"
						+ "Session Plan : "+sessionPlan+""
						+ "<br><br>"
						+ "<a style='text-decoration:underline; font-weight:bold' href='"+prop.getProperty("PROJECT")+"'>Click here to view details and confirm session</a><br><br>"
