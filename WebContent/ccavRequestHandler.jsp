...
<body>
	<%
	 ...
	 String ccaRequest="merchant_id="+merchant_id+ "&currency=INR&" +"language=EN&" + "redirect_url=" +prop1.getProperty("REDIRECT_URL") +"cancel_url="+prop1.getProperty("CANCEL_URL"), pname="", pvalue="";
