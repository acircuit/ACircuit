				    		...
				    		<div class="each-session-div col-xs-12">
					    			<div class="col-xs-10">
					    				<div class="advisor_details" >
				                                    ...
				                                    <p class="session-status" >Status: <span class="condition"><i class="fa fa-check"></i> Accepted</span><span class="time"> 23 min ago</span></p>
					    			...
					    			<div class="col-xs-2 mode-div">
					    				 <img class="mode-img" src="assets/img/phone.png"> <span class="mode-type">Phone </span>
					    				<br>
					    				<span class="session-id">Session ID 1214113</span>
					    			</div>
				    			</div>
				    			<div class="each-session-div col-xs-12">
					    			<div class="col-xs-10">
