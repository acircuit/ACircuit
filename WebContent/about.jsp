...
<title>Why, How & Who? | Advisor Circuit</title>
</head>
<style>
 ...
 <div id="wrapper">
  <%@include file="/notify.jsp" %>
 	<div class="do-not-scroll " style="width:100%">
   	...
   	<div class="main-body-div container no-padding"  id="page-content-wrapper" style="background-color: white;">
	   	<div class="col-xs-12 body-head-div"  style="text-align:center !important">
								<span class="about-text-top-head">ABOUT US</span>
								<br>
								<br>
								<span class="about-us-head-small">Career goals aren’t meant to be compromised</span>
		</div>
	</div>
	<div class="blue-div col-xs-12"> 
		<span>We’re addicted to dreams. And it just doesn’t make any sense to lose out on them for lack of guidance.<br><br>
		 Our aim is to help people like us choose the right opportunities, prepare better for their career goals and forge passions into realities.<br>
		  We feel this can only be achieved if we network, connect, talk and learn from people who’ve been there and done that and this is why we built<br>
		  <fmt:bundle basename="ac.resources.Path" prefix="path.">
		  <span class="blue-text-b-div"> <a href=<fmt:message key="home_secured"/>>www.advisorcircuit.com.</a></span><br><br>
		  </fmt:bundle>
		   At Advisor Circuit, people connect & talk to advisors conveniently and leverage their knowledge for the smallest or the most critical career decisions in their lives. <br>It’s a network that helps you reach where you want to go and faster.</span>
		</div>
	</div>
	<div class="main-body-div container no-padding"  id="page-content-wrapper" style="background-color: white;">
	   <div class="icon-row-b-div col-xs-12">
	   		<div class="each-row-div col-xs-12 col-sm-8 col-sm-offset-2 no-padding-xs">
	   			<div class="icon-b-div col-xs-3 no-padding-xs">
	   				<img src="assets/img/about1.svg">
	   			</div>
	   			<div class="text-b-div col-xs-9 no-padding-xs">
	   				<span class="text-head">Why Did We Start</span><br><br>
	   				<span class="b-div-text">Analytics, Consulting, KPO, Advertising, Education, Social sector, IT Services, Entrepreneurship & Marketing. These are the fields we shifted before homing on to what we really wanted to do. It was confusing, we didn't like it and we knew a lot of people were going through the same.</span>
	   			</div>
	   		</div>
	   		<div class="each-row-div col-xs-12 col-sm-8 col-sm-offset-2 no-padding-xs">
	   			<div class="icon-b-div col-xs-3 no-padding-xs">
	   				<img src="assets/img/about2.svg">
	   			</div>
	   			<div class="text-b-div col-xs-9 no-padding-xs">
	   				<span class="text-head">What Did We Realize</span><br><br>
	   				<span class="b-div-text">We would have achieved a lot more if we’d have just spoken to the right people.</span>
	   			</div>
	   		</div>
	   		<div class="each-row-div col-xs-12 col-sm-8 col-sm-offset-2 no-padding-xs">
	   			<div class="icon-b-div col-xs-3 no-padding-xs">
	   				<img src="assets/img/about3.svg">
	   			</div>
	   			<div class="text-b-div col-xs-9 no-padding-xs">
	   				<span class="text-head">Who Are We</span><br><br>
	   				<span class="b-div-text">We’re a part, just like you of a network with great potential. If you’re curious, follow us on 
	   				
	   				<span class="btext"><a href="https://www.linkedin.com/company/advisor-circuit?trk=ppro_cprof" target="blank">LinkedIn </a></span>& <a href="https://www.facebook.com/advisorcircuit" target="blank">Facebook.</a></span>
	   			</div>
	   		</div>
	   </div>
	   <div class="signup-div col-xs-12">
	   	<div class="col-xs-12 col-sm-6 s-text-div">
	   		<span class="signup-text">Not a part of Advisor Circuit?</span>
	   	</div>
	   	<div class="col-xs-12 col-sm-6 s-button-div">
