...
<div class="modal fade" id="askquestion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <br>
								      <form class="ask-form"> 
								      	<textarea  class="form-control ask-question" id="question"  placeholder="Type your Question" required="required" maxlength="2000"> </textarea>
								...
								<div class="modal fade" id="answerquestion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      ...
								      <br>
								      <form class="ask-form"> 
								      	<textarea  class="form-control ask-question" id="answer"  placeholder="Type your Question" required="required" maxlength="2000" > </textarea>
