...
<!--   <link href="assets/js/prettify.css" rel="stylesheet">
    ...
    <script src="assets/js/prettify.js"></script>
		<link href="assets/js/index.css" rel="stylesheet">
...
<%-- <div class="container">
  <div class="hero-unit">
    ...
    * https://github.com/mindmup/bootstrap-wysiwyg/blob/master/README.md#customising-
    ...
    <div>
    <form action="RaptorController" method="post">
         <pre> <textarea id="editor" rows="50" cols="100" name="data"></textarea></pre>
         <input type="button" class="btn" onclick="ShowCode()">
    </form>
        <c:forEach items="${list}" var="ans">
         <p>${ans}</p>
    </c:forEach>
    </div>
  ...
  <div>
  <form action="RaptorController" method="post">
         <pre> <textarea id="editor1" rows="50" cols="100" name="data"></textarea></pre>
