   	...
   	<div class="main-body-div container"  id="page-content-wrapper">
  		...
  		<div class="row category-filter-row">
   			...
   			<div class=" row no-padding-xs stopnow">
   				<div class="col-sm-3 hidden-xs filters">
   						...
   						<form>
							 ...
							 <c:forEach var="industry" items="${industries}">
							      <div class="form-group squaredThree">
							  	      <input type="checkbox" id="college${industry}" name="${industry}"/>
								      <label for="college${industry}"></label><span>${industry}</span>
							      </div>
							  </c:forEach>
						...
						<form>
							   ...
							   <c:forEach var="institution" items="${institutions}">
							      <div class="form-group squaredThree">
								      ...
								      <label for="${institution}"></label><span>${institution}</span>
							      </div>
							  </c:forEach>
						</form>
							<!-- Modal -->
   				...
   				<div class="col-xs-12 col-sm-9 no-padding" id="experts-card-div">


   					<div class="col-xs-12 information-div no-padding text-center-xs">
   					...
   					<div class="col-xs-12 filters-active">
	   						<span>Filters:</span>
