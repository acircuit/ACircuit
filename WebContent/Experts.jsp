							    ...
							    <div class="modal-content">
							     ...
							     <div class="col-xs-12">
							    	...
							    	<div class="row" style="margin-top: 20px;">
								    	<div id="filterModal" class="col-xs-12" id="modal-filter">
...
function OpenFIlterModal(elem){
	...
	if(type =="industryFilter"){
		<c:forEach items="${industries}" var="industry">
	 	   ...
	 	   if(delimit){
		     html = html +"<div  class='col-xs-3 alpha-div-filter filters-in-modal'><span>"+startingletter.toUpperCase()+"</span><br>";
		     started = true;
	 	   }
