...
function expertcard(value)
{
	var html='<div class="col-xs-12  col-sm-6 expert-card-div">'
			...
			+'</div>'
			+'</a>'
			+'<input name="rating" class="rating" data-min="0" data-max="5" data-step="0.5" data-stars=5 data-glyphicon="false" value="'+value.reviewCount+'" disabled>'
			...
			+'<span> <i class="fa fa-briefcase"></i> '+value.answers+' Answers </span>'
			+'</div>'
			+'</div>'
			+'</div>'
			+'</div>'
