 	...
 	<div class="do-not-scroll " style="width:100%">
   	...
   	<div class="main-body-div no-padding remove-padding" id="page-content-wrapper" >
   			...
   			<div class="body-error error-div col-xs-12" style="background-color: #EEEEEE;">
   					...
   					<span class="thanku-text">Thank You Message</span>
   					<br><br>
   					<span class="thanku-message-text">Mauris non tempor quam, et lacinia sapien. Mauris accumsan eros eget libero posuere vulputate. Etiam elit elit, elementum sed varius at, adipiscing vitae est.</span>
			</div>
