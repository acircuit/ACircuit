   						...
   						<div class="panel panel-default">
						      ...
						      <table class="table">
                                ...
                                <tr>
						            ...
						            <td>
						             <div class="modal fade" id="contact${contact.getId()}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      <div class="modal-body">
								      <span class="ask-question-modal-head">User Message</span><br>
								      <br>
