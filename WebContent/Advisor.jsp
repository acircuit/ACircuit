...
<%
                   ...
                   String advisorId = request.getParameter("a");
           	       ...
           	       String pageTitle = advisor.getName()+"| Advisor Circuit";
 ...
 <%@include file="/notify.jsp" %>
	<div class="do-not-scroll " style="width:100%">
   	...
   	<div class="main-body-div container"  id="page-content-wrapper">
			...
			<div class="expert-card">
				...
				<div class="col-xs-12 no-padding">
					<div class="b-strip">
						<div class="col-xs-12 col-sm-8 no-padding-xs text-center-xs" style="display: none;">
						...
						<span class="stars-xs"><span class="rating-no">Share the profile</span>
						<div class="addthis_sharing_toolbox text-center-xs" ></div>
						</div>
	...
	<div class="body-content">
		<div class="col-xs-12 col-sm-3 advisor-left-pannel">
			...
			<div class="session-info col-xs-12">
				<div class="session-div">
					...
					<c:choose>
					 	<c:when test="${advisor.getPhonePrice() == 0.0}">
					 	 	<span class="session-head-text">For Free</span>
					 	</c:when>
					 	<c:otherwise>
		...
		<div class="col-xs-12 col-sm-6 advisor-center-pannel">
			...
			<div class="border-b">
				<span class="a-info-each"><span class="additional-info-type" style="font-family: Open SansR;">Current City: </span><span class="additional-info-text"> ${advisor.getCity()}</span></span>
				<span class="a-info-each"><span class="additional-info-type" style="font-family: Open SansR;">Language: </span>
				<c:forEach items="${advisor.getLanguage()}" var="language">
				<span class="additional-info-text"> ${language.getLanguage()},</span>
				</c:forEach>
				</span>
				<span class="a-info-each"><span class="additional-info-type" style="font-family: Open SansR;">Industry:</span><span class="additional-info-text"> ${advisor.getIndustry()}</span></span>
			</div>
