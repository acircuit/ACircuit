...
<title>Create your Profile for a better experience | Advisor Circuit</title>
<body>
 <div id="wrapper">
   				...
   				<div class="col-xs-12 col-sm-9 ud-left-section" style="background-color: #EEEEEE;">
		   			...
		   			<div class="profile-owner-info col-xs-12 no-padding">
		   				<div class="col-xs-12 col-sm-4 dp-div-profile">
		   					 <img id="usr-image" class="profile-dp" src="${userDetails.getImage()}"><br>
		   					<span class="btext change-do change-profile">Change Profile Picture</span>
				                     ...
				                     <input id="usr-img" type="file" class="custom-file-input" style="visibility:hidden;" name="file"  aria-required="true">
												     ...
												     <label class="col-xs-3 no-padding form-label">Gender</label>
												       ...
												       <c:choose>
												          ...
												          <div class="col-xs-6 no-padding">
						                                        <input type="radio" id="radio01" name="radio" value="male" checked="checked" aria-required="true" required/>
  																<label for="radio01"><span></span>Male</label>
													 		</div>
													 		<div class="col-xs-6 no-padding">
						                                       <input type="radio" id="radio02" name="radio" value="female" />
															 <label for="radio02"><span></span>Female</label>
													 		</div>
												          </c:when>
												          <c:otherwise>
												          <div class="col-xs-6 no-padding">
						                                        <input type="radio" id="radio01" name="radio" value="male" aria-required="true" required/>
  																<label for="radio01"><span></span>Male</label>
													 		</div>
													 		<div class="col-xs-6 no-padding">
						                                       <input type="radio" id="radio02" name="radio" value="female" checked="checked"/>
															 <label for="radio02"><span></span>Female</label>
													 		</div>
												          </c:otherwise>
		   							...
		   							<div class="col-xs-6 no-padding">
			   							<div class="form-group each-form-div col-xs-12 no-padding">
												     <label class="col-xs-3 no-padding form-label">Mobile</label>
												      <div class="col-xs-9">
					                                       <input id="userphone" class="form-control" name="phone" value="${userDetails.getPhone()}" required>
												 		</div>
										</div>
			   						</div>
		   						</div>
				   							...
				   							<div class="form-group each-form-div col-xs-12 no-padding">
													     <label class="col-xs-3 no-padding form-label"></label>
													      <div class="col-xs-9">
						                                      	...
						                                      	<button type="submit" id="submit-user-profile" class="btn red-button "  style="width: 90px;margin-right: 10px;">Save</button>
		   							...
		   							<div class="col-xs-12 col-sm-6 no-padding">
			   							<div class="form-group each-form-div col-xs-12 no-padding">
												     <label class="col-xs-3 no-padding form-label">Gender</label>
												       <div class="col-xs-9 ">
						                                     <div class="col-xs-6 no-padding">
						                                        <input type="radio" id="radio01" name="radio" value="male" />
  																<label for="radio01"><span></span>Male</label>
													 		</div>
													 		<div class="col-xs-6 no-padding">
						                                       <input type="radio" id="radio02" name="radio" value="female"/>
		   						...
		   						<div class="col-xs-12 no-padding">
		   							<div class="col-xs-12 col-sm-6 no-padding">
			   							<div class="form-group each-form-div col-xs-12 no-padding">
												     <label class="col-xs-3 no-padding form-label">Occupation</label>
												       <div class="col-xs-9">
					                                       <input class="form-control" id="occupation" name="occupation" value="">
												 		</div>
										</div>
			   						</div>
		   						</div>
...
$("#submit-user-profile").click(function(event){
	...
	if($("#name").val() == ""){
		...
		$('body').scrollTop(0);
	}else if (typeof $('input:radio[name=radio]:checked').val() == "undefined") {
		event.preventDefault();
		document.getElementById("validation").style.display = 'block';
		document.getElementById("validation").innerHTML = 'Please select a Gender.';
		$('body').scrollTop(0);
	}else if ($("#occupation").val() == "") {
		event.preventDefault();
		document.getElementById("validation").style.display = 'block';
		document.getElementById("validation").innerHTML = 'Please enter your Occupation.';
		$('body').scrollTop(0);
...
function readURL(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            $('#usr-image').attr('src', e.target.result);
        }
