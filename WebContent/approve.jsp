   		   ...
   		   <div class="col-xs-12 no-padding" style="    background-color: white;">
				   	...
				   	<div class="col-xs-12 col-sm-9 right-div">
	   		    		<div class="col-xs-12 container-div-all">
		   		    		...
		   		    		<br>
		   		    		<c:choose>
		   		    		     <c:when test="${newDates.getSessionid() !=0}">
					   		...
					   		<c:if test="${newDates.getSessionid() !=0 }">
					   			...
					   			<div class="col-xs-6" style="padding-top:25px;">
					   					...
					   					<c:choose>
                                               <c:when test="${wallet <= sessionDetails.getPrice()}">
														...
														<a href="${pay}" class="btn recharg-button" style="background-color:#f2624d;width: 120px;">Make Payment</a>
                                               </c:when>
                                               <c:otherwise>
                                               		 <button type="button" class="btn recharg-button" style="background-color:#f2624d;width: 140px;">Confirm Session</button>
                                               </c:otherwise>  
                                         </c:choose>  					   			
					   			</div>
					   		</div>
